...
# Preparing layout
layout = go.Layout(title='Average Max and Min Temperatures of Each Month', xaxis_title="Average Max Temperature",
                   yaxis_title="Average Min Temperature", hovermode='closest')
